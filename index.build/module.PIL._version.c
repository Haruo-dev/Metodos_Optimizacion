...
static PyCodeObject *codeobj_ce16728575bfeb318fea1d7768c185f1;

static void createModuleCodeObjects(void) {
    module_filename_obj = mod_consts[1]; CHECK_OBJECT(module_filename_obj);
    codeobj_ce16728575bfeb318fea1d7768c185f1 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[9], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_ce16728575bfeb318fea1d7768c185f1;
    ...
    // Frame without reuse.
    frame_ce16728575bfeb318fea1d7768c185f1 = MAKE_MODULE_FRAME(codeobj_ce16728575bfeb318fea1d7768c185f1, module_PIL$_version);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_ce16728575bfeb318fea1d7768c185f1);
    assert(Py_REFCNT(frame_ce16728575bfeb318fea1d7768c185f1) == 2);
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_ce16728575bfeb318fea1d7768c185f1);
#endif
    popFrameStack();

    assertFrameObject(frame_ce16728575bfeb318fea1d7768c185f1);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_ce16728575bfeb318fea1d7768c185f1, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_ce16728575bfeb318fea1d7768c185f1->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_ce16728575bfeb318fea1d7768c185f1, exception_lineno);
    }
